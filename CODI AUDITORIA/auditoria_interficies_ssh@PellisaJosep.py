#!/usr/bin/env python3
"""
Eina d'auditoria simple amb GUI (Tkinter), escaneig amb nmap i ssh-audit
Sortida de ssh-audit processada i neta per fer-la més llegible.
"""
...
class AuditorGUI:
    def __init__(self, root):
        ...
        Button(btn_frame, text="AUDITORIA SSH", command=self.start_ssh_audit).pack(fill="x", pady=4)
